...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Create a new bullet and add it to bullets group; settings.max_bullets_allowed"""
    ...
    def _update_bullets(self):
        ...
        # Get rid of bullets that react the top of the screen
    ...
    def _update_aliens(self):
        """Check if fleet is at an edge; update positions of the fleet"""
